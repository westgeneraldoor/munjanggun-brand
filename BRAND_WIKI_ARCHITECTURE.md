...
현재 이 문맥은 중앙 상품 위키가 `vetted`인 3연동중문, 원슬라이딩, 3연동 자동, 3연동 ㄱ자, 스윙, 양개형/미서기, ABS도어 방문교체 7개 상품군에 연결한다. `candidate` 단계의 신규 상품과 쇼핑스토리 주제는 중앙 사실·주제 위키가 생기기 전까지 자동 승격하지 않는다.
