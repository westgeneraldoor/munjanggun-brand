...
2026-09-10에는 489개 전체에 대한 픽셀/OCR 보조 자료와 직접 검토 대시보드를 만들었다. 소수·금액 배수·단위를 보존한 숫자·모델 식별자를 중복과 순서까지 비교하고, 원 분석과 별도 검토 큐의 문구·OCR·프레임·영역을 완전 대조한다. 현재 집계는 기계 준비 167개·직접 픽셀 확인 322개·전체 직접 검토 464개·문구 재확인 1,053건이다. 이는 작업자가 남은 문구·claim·privacy 항목을 빠르게 확인하기 위한 자료이며 자동 승인이 아니다. 현재 승격 가능 수는 0이고 운영 차단은 유지한다.
