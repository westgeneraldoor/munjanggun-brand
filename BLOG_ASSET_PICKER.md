...
2026-09-10에는 489개 전체에 대한 픽셀/OCR 보조 자료와 직접 검토 대시보드를 만들었다. 숫자·단위·모델 식별자 집합이 OCR 영역과 정확히 같지 않으면 유사도와 무관하게 직접 검토로 보내도록 보완한 현재 집계는 기계 준비 167개·직접 픽셀 확인 322개다. 이는 작업자가 남은 문구·claim·privacy 항목을 빠르게 확인하기 위한 자료이며 자동 승인이 아니다. 현재 승격 가능 수는 0이고 운영 차단은 유지한다.
