...
12. 리뷰 근거는 정확히 쓴다: 전체 상품 리뷰 3만 개+, 대표상품 단일 리뷰 1.4만 개+.
...
- 실제 시공 사진의 품질 편차를 보정하는 세부 Lightroom/Photoshop 프리셋은 별도 문서로 만들 수 있다.
- HTML 미리보기는 이 v3.0 문서 기준으로 별도 재제작이 필요하다.
