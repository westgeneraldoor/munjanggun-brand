...
| OQ-022 | 타입 기반 브랜드 락업 운영 확정 | 2026-07-15 사용자 승인으로 그래픽 마크를 임의 제작하지 않고 `문장군 / MUNJANGGUN` 타입 락업을 현재 정본으로 사용 | 가짜 SVG·임시 심벌·앱 아이콘을 만들지 않는다. 브라우저 파비콘은 빈 데이터 URI로 불필요한 404만 방지 | 중앙 반영 완료. 향후 그래픽 로고가 필요하면 별도 의사결정과 공식 자산 등록을 거친다 | DESIGN.md, BRAND_GUIDELINE.html, design-system/assets/fonts/README.md | `resolved` |
