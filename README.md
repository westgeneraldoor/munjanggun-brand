...
> 버전: v5.16
> 최종 업데이트: 2026-09-09
> 변경 요약: 정지 이미지 12~23번의 독립 원문과 v2 교정본을 별도 불변 세그먼트로 완주해 총 24개를 교정 완료했다. 나머지 385개와 GIF 2차 검토, 공용 자료실 재개는 아직 완료하지 않았다.
