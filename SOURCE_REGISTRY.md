...
| `SRC-2026-09-04-ABS-DOOR-FRAME-FILM-DETAILPAGE` | ABS도어 문틀리폼 필름시공 상세페이지 묶음 | 비공개 intake `INTAKE-20260904-01` receipt 참조. 공개 Git 바이너리 없음 | `ASSET_INTAKE_2026-09-04.md`, `ABS_DOOR_FRAME_FILM_DETAILPAGE_ASSET_INDEX_2026-09-04.md`, `PRODUCT_WIKI_ABS_DOOR_FRAME_FILM.md`, `ABS_DOOR_FRAME_FILM_PRICE_VERIFICATION_2026-09-11.md` | 이미지/GIF 83경로, 상품번호 `13238456614`, 패키지4 문틀 필름·패키지5 문틀 리폼 | 중간. 인물·화면 신호 재검토 | 높음. 가격·패키지·시공 범위. `012.jpg` 가격은 과거 표기 | `semantic_indexed` | `reviewed_candidate` |
