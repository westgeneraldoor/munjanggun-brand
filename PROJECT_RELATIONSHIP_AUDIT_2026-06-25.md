...
> 상태: 2026-06-25 기준 스냅샷. 2026-09-04 중앙 시각 디자인 체계 폐기 이후 현재 권위와 변경 이력은 `README.md`, `AGENTS.md`, `PROJECT_ADAPTERS.md`, `CHANGELOG.md`를 우선한다.
...
| `문장군_디자인` | 캐러셀/릴스 썸네일 디자인 OS | 자체 프로젝트 기준 존재 | 시각 디자인은 해당 프로젝트가 자체 관리 |
| `문장군 릴스 엔진` | 레거시 릴스 엔진 | 자체 `BRAND_CONTEXT.md`, `BRAND_CONTEXT_REELS_SUMMARY.md` 중심 | 강한 연계, 중앙 브리지 미흡 |
| `문장군 시공릴스` | 시공 현장 영상/사진 릴스 | 자체 브랜드·제작 기준 중심 | 사실·현장 기준의 중앙 브리지 점검 필요 |
...
- `BRAND_CONTEXT.md`, `FIELD_JUDGMENT_RULES.md`, `PROJECT_ADAPTERS.md` 중 어디가 맞는지 먼저 판단한다.
...
| 시각 디자인 권위 혼선 | 중앙과 프로젝트의 역할이 섞일 수 있음 | 중앙은 시각 디자인을 관리하지 않고 프로젝트가 자체 관리 |
...
3. `문장군_디자인`이 중앙을 시각 디자인 권위로 인용하지 않는지 확인한다.
